...
Sock.prototype.emit = function(event, data, cb) {
  ...
  this._write(Serializer.serialize(event, data, mt, this._messageId));
};
...
Sock.prototype._write = function(buff) {
...
Sock.prototype._ackCallback = function(messageId) {
  ...
  return function(data) {
    _this._write(Serializer.serialize('', data, Serializer.MT_ACK, messageId));
  };
};
