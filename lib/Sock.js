...
Sock.prototype._createWriteStream = function (event, data, opts) {
  opts = opts !== undefined ? opts : {};

  var _this = this;
  opts.messageId = this._nextMessageId();

  this._send(event, data, opts.cb !== undefined ?
      Serializer.MT_DATA_STREAM_OPEN_WITH_ACK : Serializer.MT_DATA_STREAM_OPEN, opts);
