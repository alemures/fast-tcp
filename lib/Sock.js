...
function Sock(opts) {
  ...
  this._useQueue = ut.isBoolean(opts.useQueue) ? opts.useQueue :
      Constants.USE_QUEUE;

  this._queueSize = ut.isNumber(opts.queueSize) ? opts.queueSize :
      Constants.QUEUE_SIZE;
...
Sock.prototype._bindEvents = function() {
  ...
  this._socket.on('connect', function() {
    /**
     * Connected underlying net.Socket and waiting register from server.
     *
