 ...
 *        of inactivity on the socket. When an idle timeout is triggered the socket will emit
 *        an 'error' event and the connection will be destroyed. If timeout is 0, then the
 *        existing idle timeout is disabled.
