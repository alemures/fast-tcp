 ...
 *                                  the socket will receive a 'timeout' event but the connection
 *                                  will not be severed. The user must manually end() or destroy()
 *                                  the socket. If timeout is 0, then the existing idle timeout
 *                                  is disabled.
 * @constructor
 * @augments Sock
