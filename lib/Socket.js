...
Socket.prototype._msgListener = function(msg) {
  switch (msg.mt) {
    case Serializer.MT_REGISTER:
      ...
      /**
       * The socket is connected and registered. The messages will be
       * sent without using an intermediate queue and {@link Socket#id}
       * will have a valid identificator set by the server.
       *
