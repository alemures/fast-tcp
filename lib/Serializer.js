module.exports = class Serializer {
  constructor(opts) {
    this._objectSerializer = opts.objectSerializer || this._defaultObjectSerializer;
    this._objectDeserializer = opts.objectDeserializer || this._defaultObjectDeserializer;
  }
