...
module.exports = class Server extends EventEmitter {
  ...
  _emit(event, data, opts) {
    const socketIds = opts.sockets !== undefined ? opts.sockets : [];
    const rooms = opts.rooms !== undefined ? opts.rooms : [];
    const except = opts.except !== undefined ? opts.except : [];
